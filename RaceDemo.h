...
class RaceDemo: public State<Application>
{
private:
	RaceDemo(){}
	//Text Output Stuffs
	...
	D3DXMATRIX m_mFLWorld;		//floor world matrix
		...
		//GameState Stuff
	D3DXVECTOR3 playPos[8];
	D3DXVECTOR3 playVel[8];
	D3DXVECTOR3 playAcc[8];
	D3DXVECTOR3 playRot[8];
	D3DXVECTOR3 playSca[8];
	D3DXMATRIX playWor[8];
