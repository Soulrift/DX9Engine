...
ShadowMapDemo* ShadowMapDemo::Instance()
{
	static ShadowMapDemo temp;
	return &temp;
}

void ShadowMapDemo::InitializeState(Application* owner)
{
...
void ShadowMapDemo::UpdateScene(Application* owner, double dT)
{
...
void ShadowMapDemo::RenderScene(Application* owner)
{
...
void ShadowMapDemo::OnResetDevice(Application* owner)
{
	//update perspective
	float w = (float)owner->getParam().BackBufferWidth;
	float h = (float)owner->getParam().BackBufferHeight;
...
void ShadowMapDemo::OnLostDevice(Application* owner)
{
	//m_eEffect->OnLostDevice();
}

void ShadowMapDemo::LeaveState(Application* owner)
{
	//m_eEffect->Release();
